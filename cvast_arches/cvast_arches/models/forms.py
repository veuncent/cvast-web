...
class SummaryForm(ResourceForm):
    ...
    def update(self, data, files):
        ...
        if self.resource.entitytypeid in ('HERITAGE_RESOURCE.E18', 'HERITAGE_RESOURCE_GROUP.E27'):   
            self.update_nodes('HERITAGE_RESOURCE_CLASSIFICATION.E55', data)
    ...
    def load(self, lang):
        ...
        if self.resource:
            if self.resource.entitytypeid in ('HERITAGE_RESOURCE.E18', 'HERITAGE_RESOURCE_GROUP.E27'):            
                self.data['HERITAGE_RESOURCE_CLASSIFICATION.E55'] = {
                    'branch_lists': self.get_nodes('HERITAGE_RESOURCE_CLASSIFICATION.E55'),
                    'domains': {'HERITAGE_RESOURCE_CLASSIFICATION.E55' : Concept().get_e55_domain('HERITAGE_RESOURCE_CLASSIFICATION.E55')}
                }
