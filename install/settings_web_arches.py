...
DATABASES = {
    'default': {
        ...
        'HOST': os.environ['DB_HOSTNAME'],                      # Set to empty string for localhost. Not used with sqlite3.
...
ELASTICSEARCH_HOSTS = [
    {'host': os.environ['ES_HOSTNAME'], 'port': ELASTICSEARCH_HTTP_PORT}
...
BING_KEY = 'AoLJuIT35FYJ5vNugQR0T9UK2IN2qDHIpNepd-yhG4pXRifboo0uaxYQqZNuccYa'
...
TEMPLATE_DIRS = (
	...
	os.path.join(ROOT_DIR, '..', '..', 'arches_hip', 'arches_hip', 'templates') # Added by Vincent: arches_hip_cvast needed this, but couldn't find it
